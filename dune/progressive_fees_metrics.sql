-- Safe Test - Progressive Fee Structure Metrics
-- https://dune.com/queries/5524305
with data as (SELECT
    tx_hash,
    feature,
    is_stablecoin_pair,
...
sum(native_swaps_fees_new_approach) - sum(native_swaps_fees_as_is) as difference_native_swaps_fees,
sum(native_swaps_fees_as_is) as current_native_swaps_fees,
sum(native_swaps_fees_new_approach) as new_native_swaps_fees
from data
